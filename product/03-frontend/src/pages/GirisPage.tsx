...
// Site geneli giriş zorunluluğu (PO kararı): banka içi arayüzün (Layout.tsx)
// önündeki kapı. Portal/kurum girişiyle AYNI oturum sistemini (`/api/auth/*`)
// kullanır — ayrı bir kimlik doğrulama akışı İCAT EDİLMEDİ, yalnızca başarı
// sonrası yönlendirme hedefi farklı (`/`).
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-surface-container-low hairline-border rounded-xl p-8">
        <div className="text-center mb-8">
          <Icon name="shield_person" className="text-5xl text-primary" />
          <h1 className="font-headline-md text-headline-md text-on-background mt-2">AKS'ye Hoşgeldiniz</h1>
          <p className="font-body-sm text-body-sm text-on-surface-variant mt-1">
            Devam etmek için giriş yapın ya da hesap oluşturun.
          </p>
        </div>
